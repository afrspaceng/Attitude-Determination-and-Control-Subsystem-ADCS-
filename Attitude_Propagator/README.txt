...
The main goal is to design an attitude propagator in a modular, well-structured way and also with functions as generic as possible to ensure future reusability
in control systems.
